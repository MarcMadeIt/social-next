    ...
    <div className="p-3 flex flex-col gap-6 bg-foreground rounded-xl shadow-xl text12">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex gap-3 items-center">
          <p className="text12 text-extra py-1 px-2 bg-user rounded-md font-semibold">
        ...
        {user.desc && <p className="text12 text-text">{user.desc}</p>}
        ...
        {user.race && (
          <div className="flex gap-2 text-primary">
            ...
            <p>
              My parents is <span className="font-semibold">{user.race}</span>
            </p>
          </div>
        )}
        {user.color && (
          <div className="flex gap-2 text-primary">
            <FaAdjust size={18} />
            <p>
              The style is <span className="font-semibold">{user.color}</span>
            </p>
          </div>
        )}
      </div>
