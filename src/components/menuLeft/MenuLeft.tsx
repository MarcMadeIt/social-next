...
import { FaBookmark, FaCalendarDay, FaClone, FaComments, FaPeopleGroup, FaTags } from 'react-icons/fa6'
    ...
    <div className='flex flex-col gap-5'>
      ...
      <div className='p-3 flex flex-col gap-5 bg-foreground rounded-xl shadow-xl text-sm'>
        <div className='flex-col flex text-primary gap-4'>
          ...
          <Link href="/" className='flex gap-2 items-center hover:text-secondary transition-colors duration-300'>
          <FaComments />
            Discussions
          </Link>
          <Link href="/" className='flex gap-2 items-center hover:text-secondary transition-colors duration-300'>
